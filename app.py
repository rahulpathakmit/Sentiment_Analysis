...
# use deque here to store the changing trend of number of tweets
                ...
                html.Div(
                    [
                        html.A(
                            ...
                            href='https://www.linkedin.com/in/rahulpathakmit/',
                            target='_blank',
                            className="app__header__title"
                        ),
                        html.P(
                            "This app streams tweets about brands in real time and displays live charts for brand improvement.",
        ...
        html.Div(
            [
                html.Div(
                    [
                        html.P(
                            "Brands: The keywords tracked by the streaming server includes: #Facebook, #Instagram and #Apple",
